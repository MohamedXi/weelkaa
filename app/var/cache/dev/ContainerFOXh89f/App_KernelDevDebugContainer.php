...
class App_KernelDevDebugContainer extends Container
{
    ...
    protected function getSecurity_User_Provider_Concrete_AppUserProviderService()
    {
        ...
        return $this->privates['security.user.provider.concrete.app_user_provider'] = new \Symfony\Bridge\Doctrine\Security\User\EntityUserProvider(($this->services['doctrine'] ?? $this->getDoctrineService()), 'App\\Entity\\User', 'emailAddress', NULL);
    }
